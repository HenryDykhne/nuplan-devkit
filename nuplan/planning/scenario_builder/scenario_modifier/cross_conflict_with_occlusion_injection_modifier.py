...
class CrossConflictWithOcclusionInjectionModifier(ConflictInjectionAndOcclusionInjectionModifier):
    ...
    def modify_scenario(self, runner: SimulationRunner) -> List[SimulationRunner]:
        ...
        for conflict_connector in valid_conflicting_connectors:
            ...
            for ego_speed_offset in self.SPEED_OFFSETS:
                ...
                *_, last = goal_segment.baseline_path.linestring.coords #we use the last point in a linestring far away to start setting our goal
                ...
                conflict_vehicle_token = "cross_conflict_inserted"
                ...
                base_modifier_string = "_cross_conflict_injection_and_occlusion_injection_"
        ...
        return [all_modified_simulation_runners[16]] #returining just one for bug testing purposes 16 id the right one
...
class CrossConflictWithOcclusionInjectionModification(AbstractModification):
